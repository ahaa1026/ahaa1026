...
#                        of executable (1/0)?
MODEL                = PID_MATLAB
MODULES              = main.c rtGetInf.c rtGetNaN.c rt_nonfinite.c stm32xxxx_it.c
MODULES_OBJ          = main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj stm32xxxx_it.obj 
MAKEFILE             = PID_MATLAB.mk
...
MODELLIB                  = 
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = PID_MATLAB_ref.rsp
...
# Additional includes
ADD_INCLUDES = \
 -ID:/RC/rc  -ID:/RC/rc/PID_MATLAB_stm32  -I$(MATLAB_ROOT)/extern/include  -I$(MATLAB_ROOT)/simulink/include  -I$(MATLAB_ROOT)/rtw/c/src  -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common  -I$(MATLAB_ROOT)/rtw/c/ert  -ID:/STM32-MAT/STM32/addSrc/inc 
...
%.o: $(subst ",,D:/STM32-MAT/STM32/addSrc/src)/%.cpp
	@echo ### Source $< done
...
%.o: $(subst ",,D:/STM32-MAT/STM32/addSrc/src)/%$(SRC_FILE_EXT)
	@echo ### Source $< done
